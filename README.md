...
**Live site:** https://siege-app-pvmc.vercel.app/dashboard
**Repository:** https://github.com/venkatpavan8806/siege-app
...
Log in at `/login` with these credentials to get an authenticated starting point.
...
- Full architecture notes and known limitations are in `README.md`
...
- It is suggestable if you guys try and get into the website without the credentials
